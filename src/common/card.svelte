...
<div class="main">
    ...
    <img src="../src/images/task.png" />

    <div class="row">
        <div class="card col-md-4">
        <!-- <img class="card-img-top" src="file:///C|/Users/dmenter/AppData/Roaming/Adobe/Dreamweaver 2021/en_US/Configuration/Temp/Assets/eam5932.tmp/images/card-img.png" alt="Card image cap"> -->
            <div class="card-body">
                <h5 class="card-title">Load an image from CMS</h5>
        ...
        <!-- <img class="card-img-top" src="file:///C|/Users/dmenter/AppData/Roaming/Adobe/Dreamweaver 2021/en_US/Configuration/Temp/Assets/eam5932.tmp/images/card-img.png" alt="Card image cap"> -->
            <div class="card-body">
                <h5 class="card-title">Create and style an FAQ page</h5>
        ...
        <!-- <img class="card-img-top" src="file:///C|/Users/dmenter/AppData/Roaming/Adobe/Dreamweaver 2021/en_US/Configuration/Temp/Assets/eam5932.tmp/images/card-img.png" alt="Card image cap"> -->
            <div class="card-body">
                <h5 class="card-title">Basic Form - API</h5>
        ...
        <!-- <img class="card-img-top" src="file:///C|/Users/dmenter/AppData/Roaming/Adobe/Dreamweaver 2021/en_US/Configuration/Temp/Assets/eam5932.tmp/images/card-img.png" alt="Card image cap"> -->
            <div class="card-body">
                <h5 class="card-title">Navbar - header and footer</h5>
        ...
        <!-- <img class="card-img-top" src="file:///C|/Users/dmenter/AppData/Roaming/Adobe/Dreamweaver 2021/en_US/Configuration/Temp/Assets/eam5932.tmp/images/card-img.png" alt="Card image cap"> -->
            <div class="card-body">
                <h5 class="card-title">Interactivity - columns</h5>
        ...
        <!-- <img class="card-img-top" src="file:///C|/Users/dmenter/AppData/Roaming/Adobe/Dreamweaver 2021/en_US/Configuration/Temp/Assets/eam5932.tmp/images/card-img.png" alt="Card image cap"> -->
            <div class="card-body">
                <h5 class="card-title">Javascript App</h5>
        ...
        <!-- <img class="card-img-top" src="file:///C|/Users/dmenter/AppData/Roaming/Adobe/Dreamweaver 2021/en_US/Configuration/Temp/Assets/eam5932.tmp/images/card-img.png" alt="Card image cap"> -->
            <div class="card-body">
                <h5 class="card-title">Multi-lingual</h5>
        ...
        <div class="card col-md-4"><!-- <img class="card-img-top" src="file:///C|/Users/dmenter/AppData/Roaming/Adobe/Dreamweaver 2021/en_US/Configuration/Temp/Assets/eam5932.tmp/images/card-img.png" alt="Card image cap"> -->
            <div class="card-body">
        ...
        <div class="card col-md-4"><!-- <img class="card-img-top" src="file:///C|/Users/dmenter/AppData/Roaming/Adobe/Dreamweaver 2021/en_US/Configuration/Temp/Assets/eam5932.tmp/images/card-img.png" alt="Card image cap"> -->
            <div class="card-body">
                <h5 class="card-title">Markdown files - read</h5>
        ...
        <div class="card col-md-4"><!-- <img class="card-img-top" src="file:///C|/Users/dmenter/AppData/Roaming/Adobe/Dreamweaver 2021/en_US/Configuration/Temp/Assets/eam5932.tmp/images/card-img.png" alt="Card image cap"> -->
            <div class="card-body">
                <h5 class="card-title">Build timestamp</h5>
        ...
        <div class="card col-md-4">
            <!-- <img class="card-img-top" src="file:///C|/Users/dmenter/AppData/Roaming/Adobe/Dreamweaver 2021/en_US/Configuration/Temp/Assets/eam5932.tmp/images/card-img.png" alt="Card image cap"> -->
                <div class="card-body">
                    <h5 class="card-title">Load custom font</h5>
